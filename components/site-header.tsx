      ...
      <div className="page-shell py-4">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <nav id="primary-navigation" aria-label="Primary" className={navClassName}>
            <ul className="flex flex-1 flex-col items-stretch gap-2 text-sm font-medium md:flex-row md:items-center md:gap-5">
              ...
              <li className="md:hidden">
                <Link
                  href="/consultation"
                  className="block rounded-full bg-earth-500 px-4 py-2 text-center text-sm font-semibold text-black shadow-sm ring-1 ring-earth-600/30 transition hover:bg-earth-600 hover:shadow active:scale-[0.98]"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Book Consultation
                </Link>
          ...
          <div className="hidden md:flex md:items-center">
            <Link
              href="/consultation"
              className="rounded-full bg-earth-500 px-5 py-2 text-sm font-semibold text-black shadow-sm ring-1 ring-earth-600/30 transition hover:bg-earth-600 hover:shadow focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-earth-100 active:scale-[0.98]"
            >
              Book Consultation
            </Link>
          </div>
