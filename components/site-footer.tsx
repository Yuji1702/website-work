...
export function SiteFooter() {
  return (
    <footer className="bg-text-dark text-white/90">
      <div className="page-shell grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm">
            <li>
              <Link className="hover:text-accent-pink-light" href="/services">
                Conditions We Treat
              </Link>
            </li>
            <li>
              <Link className="hover:text-accent-pink-light" href="/consultation">
                Consultation Process
              </Link>
            </li>
            <li>
              <Link className="hover:text-accent-pink-light" href="/about">
                About Dr. Sadaf
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm">
            <li>
              <a className="hover:text-accent-pink-light" href="tel:+917667265892">
                +91 76672 65892
              </a>
            </li>
            <li>
              <a className="hover:text-accent-pink-light" href="mailto:care@drzahidasadaf.com">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm">
            <li>
              <a
                className="hover:text-accent-pink-light"
      ...
      <div className="border-t border-white/20 bg-text-dark/90">
        <p className="page-shell py-4 text-xs text-white/70">
