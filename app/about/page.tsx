...
export default function AboutPage() {
  return (
    <div className="page-shell pb-16">
      <section className="grid gap-12 pt-16 lg:grid-cols-[minmax(0,1.05fr),minmax(0,0.95fr)] lg:items-center lg:gap-16">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="/services"
              className="rounded-full bg-secondary px-6 py-3 text-sm font-semibold text-text-dark shadow-sm ring-1 ring-accent-pink-pale transition hover:bg-secondary-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary"
            >
              Explore Services
            </Link>
          </div>
      ...
      <section className="mt-12 rounded-3xl bg-white/90 p-8 shadow-sm ring-1 ring-accent-pink-pale sm:p-10">
        <h2 className="text-3xl font-semibold text-text-dark">Whole-person healing philosophy</h2>
        {/* Medium screens (md) split the cards in two columns while mobile stays stacked */}
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <article className="rounded-2xl bg-accent-pink-pale/70 p-6">
