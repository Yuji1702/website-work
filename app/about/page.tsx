    ...
    <div className="page-shell pb-16">
      <section className="grid gap-12 pt-16 lg:grid-cols-[minmax(0,1.05fr),minmax(0,0.95fr)] lg:items-center lg:gap-16">
        <div className="space-y-6">
          <h1 className="text-4xl font-bold tracking-tight text-neutral-dark">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/consultation"
              className="rounded-full bg-primary px-6 py-3 text-sm font-semibold text-white shadow transition hover:bg-primary-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
            >
              Book a Consultation
            </Link>
            <Link
              href="/services"
              className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-primary shadow-sm ring-1 ring-primary-light/30 transition hover:bg-accent-pink-pale focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
            >
              Explore Services
            </Link>
          </div>
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="absolute inset-0 -z-10 rounded-full bg-accent-pink-pale blur-3xl" />
          <Image
      ...
      <section className="mt-12 rounded-3xl bg-white p-8 shadow-sm ring-1 ring-primary-light/30 sm:p-10">
        <h2 className="text-3xl font-semibold text-neutral-dark">Whole-person healing philosophy</h2>
        {/* Medium screens (md) split the cards in two columns while mobile stays stacked */}
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <article className="rounded-2xl bg-accent-pink-pale/40 p-6">
            <h3 className="text-xl font-semibold text-primary">Holistic Mind–Body–Soul Care</h3>
            <p className="mt-3 text-sm text-neutral-dark/80">
