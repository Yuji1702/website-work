    ...
    <div className="page-shell pb-16">
      <section className="pt-16">
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-text-dark">Holistic services tailored to you</h1>
          ...
          {serviceCards.map((card) => (
            ...
            >
              <div>
                ...
                <p className="mt-3 text-sm text-text-dark/80">{card.description}</p>
              </div>
              <div className="mt-6">
                <Link
                  href="/consultation"
