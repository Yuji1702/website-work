    ...
    <div className="page-shell pb-16">
      <section className="pt-16">
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-neutral-dark">Begin your consultation</h1>
      ...
      <section className="mt-12 rounded-3xl bg-white p-8 shadow-sm ring-1 ring-primary-light/30 sm:p-10" aria-labelledby="process">
        <div className="max-w-3xl">
          <h2 id="process" className="text-3xl font-semibold text-neutral-dark">
        ...
        <ol className="mt-8 grid gap-6 sm:grid-cols-2 xl:grid-cols-3" aria-label="Consultation steps">
          {steps.map((step, index) => (
            <li
              key={step.title}
              className="flex flex-col gap-3 rounded-3xl bg-accent-pink-pale/40 p-6"
            >
              ...
              <p className="text-sm text-neutral-dark/80">{step.description}</p>
            </li>
          ))}
        </ol>
      </section>
      ...
      <section className="mt-12 grid gap-10 lg:grid-cols-[minmax(0,1.1fr),minmax(0,0.9fr)] lg:items-start">
        <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-primary-light/30 sm:p-10">
          <h2 className="text-3xl font-semibold text-neutral-dark">Consultation investment</h2>
          <p className="mt-4 text-neutral-dark/80">
                ...
                <tbody className="divide-y divide-primary-light/30 bg-white/60">
                  {pricing.map((price) => (
                    <tr key={price.region}>
                      ...
                      <td className="px-4 py-3 text-primary">{price.amount}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="mt-6 space-y-3 text-sm text-neutral-dark/80">
            <p>
