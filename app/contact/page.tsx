        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl bg-white/90 p-6 shadow-sm ring-1 ring-earth-100 sm:p-8">
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-sm font-semibold">
              ...
              <a
                className="rounded-full bg-earth-400 px-4 py-2 text-white shadow-sm ring-1 ring-earth-500/30 transition hover:bg-earth-500 hover:shadow focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-earth-600 active:scale-[0.98]"
