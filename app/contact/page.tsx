    ...
    <div className="page-shell pb-16">
      <section className="grid gap-10 pt-16 lg:grid-cols-[minmax(0,1fr),minmax(0,0.8fr)] lg:items-start">
        <div className="space-y-6">
          <h1 className="text-4xl font-bold tracking-tight text-text-dark">We’re here to help</h1>
          ...
          <div className="rounded-3xl bg-white/90 p-6 shadow-sm ring-1 ring-accent-pink-pale sm:p-8">
            <h2 className="text-xl font-semibold text-primary">Contact details</h2>
            <ul className="mt-4 space-y-3 text-sm text-text-dark/80">
              <li>
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-sm font-semibold">
              ...
              <a
                className="rounded-full bg-accent-pink px-4 py-2 text-text-dark"
          ...
          <div className="rounded-3xl bg-white/70 p-6 shadow-inner ring-1 ring-accent-pink-pale sm:p-8">
        ...
        <div className="rounded-3xl bg-primary/95 p-8 text-white shadow-lg sm:p-10">
          ...
          <div className="mt-8 rounded-2xl bg-white/10 p-5 text-sm">
            ...
            <div className="mt-4 h-40 w-full rounded-xl bg-gradient-to-br from-emerald-700/50 to-emerald-500/40 p-4 text-xs text-white">
